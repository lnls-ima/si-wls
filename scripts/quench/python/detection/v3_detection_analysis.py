...
if __name__ == "__main__":
    ...
    for rrr in RRRs:
        for b in Bs:
            ...
            # DEBUG
            print('vqs = {}'.format(vqs))
            print('Jop = {}, Tjoule = {}, Top = {}, resusty = {}'.format(
                wire.Jop, wire.Tjoule, dict_high_field_parameters['Top'], wire.resty_comp
            ))
            print('wire.C_comp = {}, wire.avg_C_comp = {}'.format(wire.C_comp, wire.avg_C_comp))
            print('wire.k_comp = {}, wire.avg_k_comp = {}'.format(wire.k_comp, wire.avg_k_comp))
