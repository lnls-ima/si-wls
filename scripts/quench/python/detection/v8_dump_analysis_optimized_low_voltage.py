...
if PLOT_3D:
    ...
    # DEBUG ################
    print("############# Combined Open count #############")
    print(x1)
    print(x2)
    print(combined_open_fail_cnt_matrix)
    print("#################################################")
    ########################
    # short parallel
    ...
    # DEBUG ################
    print("############# Combined Short count #############")
    print(x1)
    print(x2)
    print(combined_short_fail_cnt_matrix)
    print("#################################################")
    ########################
    ...
    # DEBUG ################
    print("############# Resistor / Open count #############")
    print(x1)
    print(x2)
    print(_np.divide(parallel_resistor_cnt_matrix, combined_open_fail_cnt_matrix))
    print("#################################################")
    ########################
    ...
    # DEBUG ################
    print("############# Resistor / Short count #############")
    print(x1)
    print(x2)
    print(_np.divide(series_resistor_cnt_matrix, combined_short_fail_cnt_matrix))
    print("#################################################")
    ########################
    _plt.show()
